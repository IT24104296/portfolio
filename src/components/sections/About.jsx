      ...
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <motion.div
            ...
            initial="hidden"
            animate={inView ? 'visible' : 'hidden'}
            className="glass neon-border rounded-2xl p-6 md:p-8 relative overflow-hidden"
          >
            ...
            <div className="flex items-center gap-4 md:gap-5 mb-6 md:mb-8 relative z-10">
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-cyan-400 to-purple-600 flex items-center justify-center font-orbitron font-black text-lg md:text-xl flex-shrink-0 animate-pulse-glow">
                V
              </div>
              <div>
                <h3 className="font-orbitron font-bold text-white text-base md:text-lg">Vahinthan</h3>
                <p className="font-mono text-xs text-cyan-400 tracking-widest mt-1">SLIIT · Software Engineering Undergraduate</p>
              </div>
            </div>

            <p className="text-slate-300 leading-relaxed mb-5 md:mb-6 relative z-10 text-justify">
              I'm a passionate{' '}
            ...
            <p className="text-slate-400 leading-relaxed mb-5 md:mb-6 relative z-10 text-justify">
            ...
            <p className="text-slate-400 leading-relaxed relative z-10 text-justify">
            ...
            <div className="flex flex-wrap gap-3 mt-8 pt-6 border-t border-white/10 relative z-10">
              {['SLIIT', 'Sri Lanka', 'Open to Internship', 'Clean Code Advocate'].map(tag => (
                <span
                  key={tag}
                  className="font-mono text-xs px-4 py-1.5 rounded-full glass neon-border text-cyan-400/80"
                >
                  {tag}
                </span>
              ))}
          ...
          <div className="flex flex-col gap-5">
            {highlights.map((item, i) => (
              <motion.div
                ...
                className={`rounded-xl p-6 border ${item.borderColor} relative overflow-hidden group cursor-default`}
